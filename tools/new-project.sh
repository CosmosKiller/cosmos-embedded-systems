...
echo "  2. Use cosmos-architect to complete docs/ARCHITECTURE.md and lock the platform."
echo "  3. Optional: git -C ${TARGET} add docs README.md && git commit"
echo "  4. Optional (Cloud Agents only): ${ROOT}/tools/install-skills-to-project.sh ${TARGET}"
